...
//        RelativeLayout l_layout = (RelativeLayout) findViewById(R.id.remote_layout);
//        l_layout.offsetLeftAndRight(5); // or HORIZONTAL
//
...
//                Uri uri = Uri.parse("C:/Users/Mariami/Downloads/video-1652301113.mp4");
...
//        }
//        catch (Exception ex){
//            Log.e("videoError", ex.getLocalizedMessage());
//        }
//
...
//        });
        ...
        myVideoView.setVideoURI(Uri.parse("android.resource://com.mediatek.labs.linkitremote/"+ R.raw.video));
...
//            final VideoView videoView = new VideoView(new contex);
//            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
//            layoutParams.setMargins(10, 10, 10, 10);
//            videoView.setLayoutParams(layoutParams);
